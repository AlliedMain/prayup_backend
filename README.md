...
Pray Up is an extension of the music heroku application and is built on top of the django platform and uses POSTGRESQL as a database, and uses external storage to store custom prayers and requests.
